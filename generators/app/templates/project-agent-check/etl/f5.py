...
class <%=startCaseAgentCheckName%>Check(AgentCheck):
    ...
    def get_health_stream(self, instance):
        return HealthStream(HealthStreamUrn(instance.instance_type, "<%=snakeCaseAgentCheckName%>_health"), expiry_seconds=0)
